...
export const rooms = [
  ...
  },
  {
    ...
    longDescription:
      "Each of these rooms features a private balcony, offering a personal space to enjoy a cup of tea, read a book, or simply soak in the magnificent mountain scenery. The rooms are tastefully decorated to create a warm and inviting atmosphere.",
  ...
  },
  {
    ...
    longDescription:
      "Situated with a direct view of the glistening river, these rooms are designed for tranquility. Large floor-to-ceiling windows ensure you never miss a moment of the natural beauty outside. The elegant interiors and plush furnishings provide a comfortable and relaxing stay.",
  ...
  },
  {
    ...
    longDescription:
      "Our Family Suites are designed to be a home away from home. With interconnected rooms, a separate living area, and kid-friendly amenities, they provide ample space and comfort for the entire family. Create lasting memories together in the heart of nature.",
...
export const testimonials = [
  {
    ...
    quote:
      "An absolutely magical experience. The views are breathtaking, and the hospitality is second to none. We felt completely rejuvenated. A true haven at The Forest Gate!",
  ...
  },
  {
    ...
    quote:
      "We hosted our corporate retreat here and it was a massive success. The serene environment was perfect for brainstorming, and the adventure activities were great for team building.",
    name: "Vikram Singh",
  ...
  },
  {
    ...
    quote:
      "The best family vacation we've ever had. The kids loved the play area and open spaces, and we loved the peace and quiet. The family suite was perfect. We'll be back!",
  ...
  },
  {
    ...
    quote:
      "The Forest Gate delivered far beyond our expectations. From strategy to execution, their team worked like an extension of ours. The final product not only looked amazing.",
    name: "Priya Desai",
  ...
  },
  {
    ...
    quote:
      "I've stayed at many luxury resorts, but none match the attention to detail and genuine care at The Forest Gate. They made our entire vacation feel effortless.",
    name: "Rajesh Kumar",
    location: "Dubai, UAE",
    timeAgo: "1 month ago",
    stars: 5,
  },
  {
    ...
    quote:
      "Our wedding at The Forest Gate was a dream come true. The team's creativity and precision brought our vision to life. It was a brand presence we’re truly proud of.",
    name: "Sameer & Isha",
...
export const detailedExperiences = [
  {
    title: "Trekking & Nature Trails",
    description:
      "Embark on guided treks that wind through ancient forests and past cascading waterfalls. Our trails range from gentle walks suitable for all ages to challenging hikes for the seasoned adventurer. Discover the local flora and fauna and breathe in the crisp mountain air.",
    image: "exp-trekking",
  ...
  },
  {
    ...
    description:
      "Find your inner peace at our specially designated relaxation spots along the riverbank. These tranquil locations are perfect for yoga, meditation, reading a book, or simply listening to the soothing symphony of flowing water.",
    image: "exp-river-relax",
    iconName: "river-view",
  },
  {
    ...
    description:
      "For the thrill-seekers, we offer a range of adventure activities including rock climbing, rappelling, and ziplining, all under the supervision of certified instructors. Test your limits and create exhilarating memories.",
    image: "exp-sports",
    iconName: "adventure",
  },
  {
    ...
    description:
      "Our expansive green lawns are the perfect setting for a variety of outdoor games. From a friendly match of cricket or badminton to organized group activities, there's always something to keep you entertained.",
    image: "exp-outdoor-games",
    iconName: "lawns",
  },
  {
    ...
    description:
      "Our dedicated kids' zone is a haven of fun for our youngest guests. With safe and engaging play equipment and a host of planned activities, your children will be entertained for hours.",
    image: "exp-kids-zone",
    iconName: "family",
  },
  {
    ...
    description:
      "We believe that pets are family. Our resort features large, open, and safe areas where your four-legged companions can roam, play, and enjoy the holiday with you.",
    image: "exp-pet-friendly",
    iconName: "pet",
  },
  {
  ...
  },
  {
    ...
    description:
      "Far from the pollution of the city, our skies are a canvas of cosmic wonders. On clear nights, join our stargazing sessions to marvel at constellations, planets, and the Milky Way through our powerful telescope.",
    image: "exp-stargazing",
    iconName: "stargazing",
  },
];
...
export const amenities = [
  ...
  },
  {
    ...
    description:
      "Enjoy a private movie screening with your loved ones in our cozy, state-of-the-art mini cinema.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Dine under the stars in our enchanting open-sky dining area, offering a unique culinary experience.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "From pool and table tennis indoors to cricket and badminton outdoors, we have activities for everyone.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Host your special events, from weddings to corporate retreats, in our versatile and beautiful spaces.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Gather around a warm bonfire on chilly evenings for stories, music, and camaraderie.",
    longDescription:
...
export const faqs = [
  {
    ...
    answer:
      'Our standard check-in time is 2:00 PM and check-out is at 11:00 AM. Early check-in or <a href="/policy">late check-out</a> is subject to availability and may incur additional charges.',
  },
  {
    question: "Is the resort pet-friendly?",
    answer:
      "Yes, we are a pet-friendly resort! We have designated open areas for pets to play. Please inform us at the time of booking if you will be bringing a pet.",
  },
  {
    question: "Do you have free Wi-Fi?",
    answer:
      "Yes, complimentary Wi-Fi is available for all our guests throughout the resort premises, including rooms, restaurants, and common areas.",
  },
  {
    question: "What kind of activities are available for kids?",
    answer:
      "We have a dedicated kids' play zone with swings and slides, as well as large open lawns for them to run around. We can also arrange for activities like drawing, and storytelling sessions upon request.",
  },
  {
    question: "Is parking available at the resort?",
    answer:
      "Yes, we offer complimentary and secure parking for all our guests. You do not need to reserve a parking spot in advance.",
  },
  {
    question: "How do I get to the resort?",
    answer:
      "The resort is accessible by road. The nearest airport is in Kullu, and the nearest major railway station is in Chandigarh. We can arrange for a taxi service from the airport or station upon request. You can find our exact location on the Contact page.",
  },
];
...
export const wildlifeViewpoints = [
  ...
  },
  {
    title: "Sambar Deer",
    description:
      "The largest of the Indian deer, the Sambar is a magnificent sight as it moves through the dense forest undergrowth.",
    image: "/assets/images/forestgate animal photos/Sambar Deer.jpg",
  ...
  },
  {
    title: "Golden Jackal",
    description:
      "Usually heard before they are seen, the jackal's evening howls are a quintessential part of the mountain's night symphony.",
    image: "/assets/images/forestgate animal photos/Golden Jackal.jpg",
    imageHint: "jackal mountain",
  },
  {
    title: "Indian Grey Mongoose",
    description:
      "A swift and fearless predator, the mongoose is a helpful presence in our ecosystem, keeping the balance of nature in check.",
    image: "/assets/images/forestgate animal photos/Indian Grey Mongoose.jpg",
    imageHint: "mongoose nature",
  },
  {
    title: "Rhesus Macaque",
    description:
      "Our clever primate neighbors, these macaques are highly social and a delight to observe from a respectful distance.",
    image: "/assets/images/forestgate animal photos/Rhesus Macaque.jpg",
...

  {
    ...
    description:
      "The nocturnal architect of the forest floor, recognizable by its long quills that it uses for defense against predators.",
    image:
      "/assets/images/forestgate animal photos/Indian Crested Porcupine.webp",
    imageHint: "porcupine forest",
  },
  {
    title: "Indian Hare",
    description:
      "Quick and alert, the Indian hare can be spotted darting across the open glades during the twilight hours.",
    image: "/assets/images/forestgate animal photos/Indian Hare.jpg",
  ...
  },
  {
    ...
    description:
      "Explore the incredible variety of avian life that calls our sanctuary home. From vibrant songbirds to powerful raptors.",
...

  {
    ...
    description:
      "The ancestor of the domestic chicken, these birds bring a splash of color and a loud morning call to the forest edge.",
    image: "/assets/images/forestgate animal photos/Red Junglefowl.webp",
    imageHint: "junglefowl bird",
  },
  {
    title: "Kalij Pheasant",
    description:
      "With its glossy blue-black feathers, the Kalij is a ground-dwelling bird often found in the thick undergrowth.",
    image: "/assets/images/forestgate animal photos/Kalij Pheasant.jpg",
    imageHint: "pheasant bird",
  },
  {
    title: "Crested Serpent Eagle",
    description:
      "A powerful raptor often seen soaring high above the valley currents, searching for its next meal.",
    image: "/assets/images/forestgate animal photos/Crested Serpent Eagle.jpg",
  ...
  },
  {
    ...
    description:
      "Recognizable by their large bills and unique nesting habits, these birds are essential seed-dispersers for our forests.",
    image: "/assets/images/forestgate animal photos/Indian Grey Hornbill.webp",
    imageHint: "hornbill bird",
  },
  {
    title: "White-throated Kingfisher",
    description:
      "A brilliant flash of blue, this kingfisher is often seen perched near the river, waiting for a chance to dive.",
    image:
      "/assets/images/forestgate animal photos/White-throated Kingfisher.jpg",
...

  {
    ...
    description:
      "Always in groups, these 'Seven Sisters' are known for their noisy and social behavior among the shrubs.",
    image: "/assets/images/forestgate animal photos/Jungle Babbler.jpg",
    imageHint: "babbler bird",
  },
  {
    title: "Oriental Magpie Robin",
    description:
      "A beautiful songbird that welcomes the dawn with its melodic and flute-like whistles.",
    image: "/assets/images/forestgate animal photos/Oriental Magpie Robin.jpg",
  ...
  },
  {
    title: "Spotted Dove",
    description:
      "The gentle cooing of the spotted dove is a soothing background sound to the peaceful atmosphere of Forest Gate.",
    image: "/assets/images/forestgate animal photos/Spotted Dove.jpg",
    imageHint: "dove bird",
  },
  {
    title: "Grey Francolin",
    description:
      "A ground-dwelling bird known for its distinctive loud calling, usually heard during the early morning hours.",
    image: "/assets/images/forestgate animal photos/Grey Francolin.webp",
