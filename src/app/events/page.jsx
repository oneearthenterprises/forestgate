        ...
        <div className="bg-[#fcfcfc] overflow-x-hidden">
            ...
            <section className="relative h-[85vh] min-h-[600px] w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-[10rem] font-bold text-white leading-none tracking-tighter uppercase drop- font-playfair">
                            Celebrations
                        </h1>
                        
                        <div className="flex flex-col items-end md:mr-20 -mt-2 md:-mt-6">
                            <p className="font-kaushan text-2xl md:text-5xl text-white drop-">
                                & bespoke curation
                            </p>
