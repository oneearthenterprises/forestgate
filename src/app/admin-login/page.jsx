    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row overflow-hidden relative">
        ...
        <div className="max-w-md w-full mx-auto flex flex-col h-full py-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <p className="text-muted-foreground mb-8">
              Access the management portal for The Forest Gate.
            </p>
            ...
            <Form {...form}>
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold text-xs uppercase tracking-widest text-muted-foreground ml-4">
                        Email address
                      </FormLabel>
                      <FormControl>
                        <Input
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-primary">
        ...
        <Image
          src={
            heroImage?.imageUrl ||
            "https://images.unsplash.com/photo-1540346941493-3f8d5d87e169?auto=format&fit=crop&q=80&w=1200"
          }
          alt="Resort View"
          fill
          className="object-cover"
        ...
        <div className="absolute inset-0 z-20 p-16 flex flex-col justify-end text-white">
          ...
          <p className="text-white/80 text-lg font-light max-w-md">
            ...
            the tools needed to deliver unforgettable guest experiences.
          </p>
        </div>
      </div>
    </div>
