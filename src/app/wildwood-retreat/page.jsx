...
const wildwoodSchema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'HotelRoom',
      '@id': 'https://forestgatetrails.com/wildwood-retreat#accommodation',
    ...
    {
      '@type': 'FAQPage',
      '@id': 'https://forestgatetrails.com/wildwood-retreat#faq',
      mainEntity: [
        {
          '@type': 'Question',
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://forestgatetrails.com/wildwood-retreat#breadcrumb',
      itemListElement: [
        {
          '@type': 'ListItem',
          position: 1,
