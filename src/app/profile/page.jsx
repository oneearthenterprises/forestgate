                ...
                <div className="relative group">
                    ...
                    <Avatar className="h-24 w-24 border-4 border-white shadow-xl bg-white relative overflow-hidden">
                        ...
                        <AvatarFallback className="bg-primary/5 text-primary font-bold text-2xl">
                            {form.getValues('name')?.substring(0, 2).toUpperCase() || <User className="h-10 w-10 text-primary/30" />}
                        </AvatarFallback>
                        ...
                        <div className="pt-8 border-t">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <FormField 
                                    ...
                                    render={({ field }) => ( 
                                        <FormItem> 
                                            <FormLabel className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Date of Birth</FormLabel> 
                                            <FormControl>
                                                <div className="relative">
                                                    <Input type="date" className="h-12 border-gray-200 focus:border-primary focus:ring-1 pr-10" {...field} />
                                                </div>
                                            </FormControl> 
                                            <FormMessage /> 
                                        </FormItem> 
                                ...
                                <FormField 
                                    ...
                                    render={({ field }) => ( 
                                        <FormItem> 
                                            <FormLabel className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Anniversary Date</FormLabel> 
                                            <FormControl>
                                                <div className="relative">
                                                    <Input type="date" className="h-12 border-gray-200 focus:border-primary focus:ring-1 pr-10" {...field} />
                                                </div>
                                        ...
                                        <FormItem> 
                                            ...
                                            {field.value === "Salaried" && (
                                                <div className="mt-2 text-xs font-medium text-primary">
                                                    ...
                                                    <p className="mt-1 text-muted-foreground">If salaried user books a corporate party, next visit gets 10% discount.</p>
                                                </div>
                                            )}
                                            <FormMessage /> 
                                        </FormItem> 
                                    ...
                                    <FormField 
                                        ...
                                        render={({ field }) => ( 
                                            <FormItem> 
                                                ...
                                                <FormControl>
                                                    <Input className="h-12 border-gray-200 focus:border-primary focus:ring-1" placeholder="Enter your company name" {...field} />
                                                </FormControl> 
                                                <div className="mt-2 text-xs font-bold text-primary italic">"Welcome to Corporate Party"</div>
                                                <FormMessage /> 
                                            </FormItem> 
                                        )} 
                                    />
