  ...
  return (
    <section className="relative overflow-hidden flex flex-col items-center justify-center bg-[#0b2c3d] py-16 px-4">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ref={videoRef}
          src="https://res.cloudinary.com/djglckvn7/video/upload/q_auto/f_auto/v1775118172/pecockwalking_nwqj42.mp4"
          autoPlay
          loop
          muted
          playsInline
      ...
      <div className="container relative z-10 mx-auto max-w-7xl h-full flex flex-col items-center p-0 ">
        {/* Centered Creative Header */}
        <div className="text-center md:mb-24 mb-12 max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-7xl font-bold text-white tracking-tight leading-tight font-headline">
            Explore Morni Hills Destinations
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 w-full">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            <div className="relative border-l-2 border-white/30 md:pl-12 pl-6 py-4 space-y-16">
