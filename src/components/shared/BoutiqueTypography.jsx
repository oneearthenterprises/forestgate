  ...
  return (
    <section className="bg-white py-24 md:py-40 overflow-hidden border-y border-slate-100">
      <div className="container mx-auto px-4 flex flex-col items-center text-secondary">
        ...
        >
          <p className="font-kaushan text-2xl md:text-5xl text-secondary/70 italic lowercase">
        ...
        >
          ...
          <Link
            href="/gallery"
            className="group font-kaushan text-2xl md:text-5xl text-secondary/70 italic flex items-center gap-3 hover:text-secondary transition-colors"
          >
            Look for more
