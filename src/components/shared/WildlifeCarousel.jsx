      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 ">
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-foreground/60 text-lg leading-relaxed font-light">
            Our resort is nestled in a rich ecosystem. Experience the thrill of observing indigenous Morni Hills wildlife in their natural habitat.
          </p>
        </div>
                  ...
                  <CarouselItem key={index} className="pl-4 basis-[85%] md:basis-1/2 lg:basis-1/3 xl:basis-1/3">
                    <div className="relative group overflow-hidden rounded-[2.5rem] bg-card h-[300px] md:h-[500px] shadow-lg transition-all duration-500 hover:shadow-2xl border border-border/50">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 md:p-8 p-4">
                        <h3 className="font-headline text-3xl font-bold text-white md:mb-3 mb-2 tracking-tight">
                          {point.title}
                        </h3>
                        <p className="text-white/80 text-sm leading-relaxed line-clamp-3 font-light">
                          {point.description}
                        </p>
                        <div className="w-12 h-1 bg-[#fcb101] mt-1 rounded-full" />
                      </div>
                    </div>
                  </CarouselItem>
                );
